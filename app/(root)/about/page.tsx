    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-pink-100 flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="text-lg text-gray-700 max-w-2xl mb-6">
                At <strong>WhiskerWish</strong>, we're more than just a pet
                adoption platform — we’re a passionate team of animal lovers on
            ...
            <p className="text-gray-700 max-w-2xl mb-6">
                ...
                shelters and foster homes, hoping for a second chance. We're
            ...
            <p className="text-gray-600 text-sm italic max-w-md">
                Whether you’re adopting, fostering, volunteering, or spreading
                the word — you’re part of something special. Thank you for being
                here. 💛
            </p>
        </div>
    );
